...
const profileData: ProfileData = {
  ...
  bio: "I am a frontend-based product designer with a focus on web design, illustration, & visual development. I have a diverse range of experience having worked across various fields and industries.",
